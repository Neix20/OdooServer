        ...
        for line in self:
            if line.lot_id and line.product_id != line.lot_id.sudo().product_id:
                raise ValidationError(_(
                    f'This lot {line.lot_id.name}s is incompatible with this product {line.product_id.display_name}s\nLot Product ID: {line.lot_id.sudo().product_id}, Product ID: {line.product_id}'
                ))
